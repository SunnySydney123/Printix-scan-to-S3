...
def upload_to_s3_from_url(document_url, file_name):
    ...
    s3_bucket = "printixscans"  # Extracted from the bucket URL
    ...
    try:
        ...
        s3_client = boto3.client(
            ...
            region_name='ap-southeast-2'  # Region from the bucket URL
        )
        ...
        file_url = f"https://{s3_bucket}.s3.ap-southeast-2.amazonaws.com/{file_name}"
